        ...
        <div>
          <div className="flex justify-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" fill="none" className="w-16 h-16">
              <defs>
                <linearGradient id="treeGradientLogin" x1="50%" y1="100%" x2="50%" y2="0%">
                  <stop offset="0%" stopColor="#1E40AF"/>
                  <stop offset="50%" stopColor="#3B82F6"/>
                  <stop offset="100%" stopColor="#60A5FA"/>
                </linearGradient>
              </defs>
              <path d="M24 44 L24 28" stroke="url(#treeGradientLogin)" strokeWidth="4" strokeLinecap="round"/>
              <path d="M24 28 Q20 24 14 18" stroke="url(#treeGradientLogin)" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <path d="M24 28 Q28 24 34 18" stroke="url(#treeGradientLogin)" strokeWidth="3" strokeLinecap="round" fill="none"/>
              <path d="M24 28 L24 14" stroke="url(#treeGradientLogin)" strokeWidth="3" strokeLinecap="round"/>
